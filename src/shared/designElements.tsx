...
export default function DesignElements() {
  ...
  return (
    ...
    <Container>
      ...
      <p> Lorem ipsum dolor sit amet consectetur adipisicing elit <a href="#" className="color-primary"> read more </a> </p>
      ...
      <Button disabled variant="dark">Dark</Button>
      ...
      <Button disabled variant="outline-success">Success</Button>{' '}
      <Button disabled variant="outline-warning">Warning</Button>{' '}
      <Button disabled variant="outline-danger">Danger</Button>{' '}
      <Button disabled variant="outline-info">Info</Button>{' '}
      <Button disabled variant="outline-light">Light</Button>{' '}
      <Button disabled variant="outline-dark">Dark</Button>
